      ...
      <div id="cover">
        <div v-title>蜜蜂出行加盟商管理平台</div>
            <div class="content">
              ...
              <div class="loginForm">
                ...
                <el-form label-width="46px" :model="formLabelAlign" ref="formLabelAlign">
                  ...
                  <el-form-item class="userClass" prop="passWord" label="">
                    <input class="my_input" v-model="formLabelAlign.passWord" @keyup="doLogin" v-on:change="checkPsd" type="passWord" placeholder="请输入密码" tabindex="2">
              ...
              <el-dialog class="forgetPsd" id="find_back"" style=" margin: 0 auto;" title="找回密码" :visible.sync="dialogFormVisible">
