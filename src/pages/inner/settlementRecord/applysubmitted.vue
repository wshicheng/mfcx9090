  ...
  <el-dialog
    ...
    <div class="apply_account_table">
      ...
      <el-table :data="tableData" style="width: 100%; font-size:13px;">
        <el-table-column prop="riding_time" label="骑行时间" min-width="260"></el-table-column>
        <el-table-column prop="bike_number" label="车牌号" min-width="180"></el-table-column>
        <el-table-column prop="riding_duration" label="骑行时间" min-width="180"></el-table-column>
