  ...
  <div class="settlementManager">
        ...
        <el-row class="table">
          <el-table 
            ...
            <el-table-column prop="applyTimeStr" label="结算周期" width="250">
            </el-table-column>
            <el-table-column prop="applyMoney" label="结算金额(￥)" width="200">
            </el-table-column>
            <el-table-column prop="cityName" label="加盟区域" width="120">
            </el-table-column>
            <el-table-column prop="applyUserName" label="结算单确认用户" width="100">
            </el-table-column>
            <el-table-column prop="confirmTimeStr" label="结算确认日期" width="140">
            </el-table-column>
            <el-table-column label="操作" prop="del">
              <template scope="scope">
                <a v-if="currentStatus != 2" href="javascript:;" prop="cityPartnerId" id='openId' @click="openEdit(scope.row, scope.$index)" style="color:#ccc; margin-right:10px; cursor:not-allowed;" title="编辑">
                  <i class="el-icon-document"></i>
                </a>
                <a v-else href="javascript:;" prop="cityPartnerId" id='openId' @click="openEdit(scope.row, scope.$index)" style="color:#444; margin-right:10px;" title="编辑">
                  <i class="el-icon-document"></i>
                </a>
                <!--dialog 弹窗开始-->
