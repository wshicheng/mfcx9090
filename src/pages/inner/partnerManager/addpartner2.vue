	...
	<div id="addpartner_form">
          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
            ...
            <div v-if="radio=='1'">    
              ...
              <el-form-item label="加盟模式" :id="'isOnly'+ index"
                :rules="[
                    { required: true, message: '请选择加盟模式', trigger: 'blur' },
                  ]"
              >
                <el-radio-group v-model="list.isOnly" @change="checkSettleType">
                  <el-radio label="独家" value='0'></el-radio>
                  <el-radio label="非独家" value='1'></el-radio>
                </el-radio-group>
             </el-form-item>
            ...
            <!-- 加盟模式为个人 -->
            <div v-else>
              <el-form-item label="姓名" prop="companyName" :rules="[
